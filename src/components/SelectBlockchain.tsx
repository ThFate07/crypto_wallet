  ...
  return (
    <>
      <div className="h-full flex content-center items-center">
        <div className="bg-[#1D1F24] h-content w-72 md:w-96 rounded-2xl">
          <div className="flex flex-col p-5 gap-4 w-full">
            <div className="flex flex-col gap-2">
              <div>
                <h3 className="md:text-xl">Select your Blockchain</h3>
              </div>
              <div>
                <p className="text-[12px] md:text-sm text-[#8d91a4]">Choose the network for your wallet</p>
              </div>
            </div>
